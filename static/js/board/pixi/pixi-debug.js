    ...
    Object.assign(proto, {
        debugSnapshot() {
            ...
            return {
                ...
                textureDecodeGovernor: {
                    active: this.maxTextureLoads,
                    ceiling: this.textureConcurrencyCeiling,
                    costEmaMs: this.textureDecodeCostEmaMs,
                    headroomSamples: this.textureDecodeHeadroomSamples,
                    increases: this.textureDecodeGovernorIncreases,
                    decreases: this.textureDecodeGovernorDecreases,
                },
