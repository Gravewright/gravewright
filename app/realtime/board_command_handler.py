"""Board command dispatch, authorization and per-command handlers.

Responsibilities are split across three modules (maintenance plan, Etapa 8) so
...
from app.realtime.board_results import BoardCommandResult
from app.realtime.board_results import _ack
from app.realtime.board_results import _board_conflict
from app.realtime.board_results import _board_version_extra
from app.realtime.board_results import _invalid
from app.realtime.board_results import _limit_reached
from app.realtime.board_validation import _expected_board_version
from app.realtime.board_validation import _normalize_board_shape
from app.realtime.board_validation import _normalize_freehand
from app.realtime.board_validation import _normalize_text
from app.realtime.board_validation import _normalize_ttl_ms
