...
combat_encounters = Table(
    ...
    Column("interrupted_turn_index", Integer, nullable=True),
...
combat_combatants = Table(
    ...
    Column("acted_round", Integer, nullable=False, server_default=text("0")),
    Column("holding", Integer, nullable=False, server_default=text("0")),
    Column("created_at", Integer, nullable=False),
    Column("updated_at", Integer, nullable=False),
