...
Addon packages can add optional behavior, UI, hooks, settings, scene tools, overlays, content, themes, and browser runtime behavior through documented SDK capabilities.
