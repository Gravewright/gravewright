...
def _isolated_test_database(tmp_path, monkeypatch):
    """Keep every test away from the project's persistent SQLite database."""
...
def db(tmp_path, monkeypatch):
    """Enable package-storage isolation for tests that use the database."""
...
def seed_system(campaign_id: str, user_id: str, package_id: str = "valid-ruleset") -> str:
    ...
    activated = PackageActivationService().set_campaign_ruleset(campaign_id, package_id, user_id)
