...
Every example on this page is a real package under [`examples/packages/`](../../examples/packages). CI validates all of them with `grave package validate`, so the snippets below stay in sync with packages that actually pass validation.

```bash
grave package validate examples/packages
```

## Minimal addon with a toast

Package: [`examples/packages/hello-toast`](../../examples/packages/hello-toast)
...
Package: [`examples/packages/toggle-example`](../../examples/packages/toggle-example)
...
## Addon that listens for package events
...
## Package that emits versioned events
...
## Minimal ruleset skeleton

Package: [`examples/packages/my-rpg`](../../examples/packages/my-rpg)
...
Package: [`examples/packages/dark-fantasy-assets`](../../examples/packages/dark-fantasy-assets)
