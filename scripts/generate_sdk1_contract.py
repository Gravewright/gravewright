...
DTOS = {
    "ActorDTO": {"id":"string","campaign_id":"string","system_id":"string","type":"string","name":"string","folder_id":"string | null","portrait_asset_id":"string | null","token_asset_id":"string | null","version":"number","created_at":"number","updated_at":"number"},
    ...
    "AssetDTO": {"id":"string","campaign_id":"string","owner_user_id":"string","folder_id":"string | null","filename":"string","content_type":"string","byte_size":"number","width":"number | null","height":"number | null","created_at":"number","src":"string","kind":"'image' | 'pdf'"},
    "AssetListOptions": {"campaignId?":"string","kind?":"'image' | 'pdf'"},
    ...
    "TokenOptions": {"sceneId?":"string","expectedVersion?":"number"},
    "CombatBarDTO": {"value":"number","max":"number","percent":"number | null","visibility":"string"},
    "CombatantDTO": {"id":"string","actor_id":"string","token_id":"string","name":"string","initiative":"string | null","hidden":"boolean","defeated":"boolean","position":"number","is_current":"boolean","is_next":"boolean","has_acted":"boolean","can_move_up":"boolean","can_move_down":"boolean","portrait_url":"string","bar":"CombatBarDTO | null","conditions_count":"number","effects_count":"number"},
    ...
    "CombatStateDTO": {"campaign_id":"string","combat_id":"string","active":"boolean","round":"number","turn":"number","combatants":"CombatantDTO[]","current_id":"string","current_name":"string","next_id":"string","next_name":"string","config":"CombatConfigDTO","updated_actors":"RulesetEffectMutation[]","expired_effects":"RulesetEffectMutation[]","effect_ticks":"RulesetEffectMutation[]"},
    ...
    "RollIntentInput": {"actorId":"string","actionId":"string","inputs?":"ActionInput","rollOptions?":"RollOptions","targetActorId?":"string","targetTokenId?":"string","target?":"RollTarget"},
...
def _return_type(path: str) -> str:
    ...
    primitives = {
        ...
        "bus.subscribe": "Disposer", "commands.register": "void", "chat.send": "void",
    ...
    structured = {
        ...
        "combat.setTurn": "CombatStateDTO", "combat.add": "CombatStateDTO",
